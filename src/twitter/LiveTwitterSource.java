...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("MKdQu2yszKFWYM41ljhonO2Qt")
                .setOAuthConsumerSecret("c7uwgmWtp1iJebthBzewgvSIERhw4h3xJ96lY8ygN27fb3KhzO")
                .setOAuthAccessToken("1396494762715357188-XrBVhrFbPugPLEenSwaodQiDgMURht")
                .setOAuthAccessTokenSecret("Md9r4tOEoetl7UREZpHcYrAI4gteOD4cuoFQ4u4xLO2Tz");
